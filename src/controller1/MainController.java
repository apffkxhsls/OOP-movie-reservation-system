...
public class MainController implements MainViewListener {
    ...
    public MainController(ReservationRepository repository) {
        ...
        // 다시 메인 화면으로 돌아오려면 MainController를 알고 있어야 합니다.
        // 따라서 생성자를 통해 MainController 자기 자신(this)을 SeatController에게 주입해 줍니다.
        // (주의: SeatController 생성자에 MainController를 받는 구조가 필요합니다)
    ...
    public void openHistoryView() {
        ...
        if (this.mainView != null) {
            this.mainView.setVisible(false); // 기존 메인 화면 숨김
        }

        // TODO: Control 2 파트의 ReservationController를 통해 BookingHistoryView 활성화 예정
    }
